...
fourcc = cv2.VideoWriter_fourcc(*'XVID')  # Định dạng video (ở đây sử dụng XVID)
out = cv2.VideoWriter('output_video.avi', fourcc, 20.0, (980, 740))  # Tên file và thông số lưu video
